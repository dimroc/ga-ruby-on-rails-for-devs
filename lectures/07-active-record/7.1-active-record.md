...
`sequence` will guarantee a unique number is generated, in sequence, for the attribute `office_number`.

[Click here to read more on fabricator.](http://fabricationgem.org/)

Summary
=======

Test driving with [`shoulda`](https://github.com/thoughtbot/shoulda) at the model level and [`fabricator`](http://fabricationgem.org/) at the request level speed up productivity and maintanibilty over the long haul. Highly recommended!
