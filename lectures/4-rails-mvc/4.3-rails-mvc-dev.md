...
Rails now ships with jQuery, which enables data-driven postbacks. Add `jquery-rails` to your Gemfile.
...
Rather than hardcoding an entire form, lets use `simple_form` and make an edit form partial, *app/views/things/_form.html.haml*.
